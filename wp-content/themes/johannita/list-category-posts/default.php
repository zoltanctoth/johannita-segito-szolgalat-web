...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= "<h2>".$this->get_post_title($single)."</h2>";

    //Show comments:
    #$lcp_display_output .= $this->get_comments($single);

    //Show date:
    $lcp_display_output .= '<span class="date">date' . $this->get_date($single) . "</span>";
     ...
     */
    $lcp_display_output .= "<div class='content'>" . $this->get_content($single, 'p', 'lcp_content') . "</div>";
